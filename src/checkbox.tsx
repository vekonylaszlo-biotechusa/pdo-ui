  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        className="-inset-px absolute flex items-center justify-center rounded-[5px] text-highlight data-unchecked:hidden data-checked:text-background data-checked:bg-[oklch(from_var(--accent)_l_0.07_h)] transition-all duration-100 data-indeterminate:text-foreground"
