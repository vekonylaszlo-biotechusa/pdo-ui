...
function MenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      checked={checked}
      className={cn(
        "grid in-data-[side=none]:min-w-[calc(var(--anchor-width)+1.25rem)] cursor-default grid-cols-[1rem_1fr] items-center gap-2 rounded-sm py-1 ps-2 pe-4 text-base outline-none data-disabled:pointer-events-none data-highlighted:bg-highlight data-highlighted:text-highlight-foreground data-disabled:opacity-disabled sm:text-sm [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0 data-[size=touch]:py-(--spacing-touch)",
        className,
      )}
...
function MenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      className={cn(
        "flex items-center gap-2 rounded-sm px-2 py-1 text-base outline-none data-disabled:pointer-events-none data-highlighted:bg-highlight data-inset:ps-8 data-highlighted:text-highlight-foreground data-disabled:opacity-disabled sm:text-sm [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none data-[size=touch]:py-(--spacing-touch)",
        className,
      )}
      data-inset={inset}
