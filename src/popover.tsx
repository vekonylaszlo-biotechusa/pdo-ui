  ...
  return (
    <PopoverPrimitive.Portal>
      ...
      >
        <span
          className={cn(
            "relative flex origin-(--transform-origin) rounded-lg border border-border bg-popover  shadow-lg transition-[scale,opacity] not-[class*='w-']:[min-w-80] before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-depth has-data-starting-style:scale-98 has-data-starting-style:opacity-0",
            tooltipStyle &&
