...
function DialogBackdrop({
  ...
  return (
    <DialogPrimitive.Backdrop
      className={cn(
        'fixed inset-0 z-50 bg-backdrop-accent backdrop-blur-(--panel-blur) transition-all duration-normal data-ending-style:opacity-0 data-starting-style:opacity-0',
        className,
      )}
...
function DialogFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      className={cn(
        'sm:-mx-6 sm:-mb-6 flex flex-col-reverse gap-2 sm:mt-2 sm:flex-row sm:justify-end sm:rounded-b-md sm:border-t sm:bg-popover/50 sm:px-6 sm:py-4',
        className,
      )}
